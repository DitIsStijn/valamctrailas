...
module.exports.run = async (bot, message, args) => {
    ...
    var embedCreateTicket = new discord.RichEmbed()
        ...
        .setFooter("De bestel kanaal wordt aangemaakt");
    ...
    message.guild.createChannel(userName + "-" + userDiscriminator, "text").then((createdChan) => { // Maak kanaal
        ...
        createdChan.setParent(categoryId).then((settedParent) => { // Zet kanaal in category.
            ...
            settedParent.overwritePermissions(message.guild.roles.find('name', "Personeel"), { "READ_MESSAGES": true });
            ...
            var embedParent = new discord.RichEmbed()
                ...
                .setDescription("Zet hier uw bestelling! U hebt 24 uur lang om uw bestelling op te halen! Kijk hier de voorraad: http://bit.ly/OfficialAlgemeenMt !")
